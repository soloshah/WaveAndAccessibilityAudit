...
public class HomepageSteps implements BaseTest {
    ...
    public static String newUserPageURL = "https://cemsman.herokuapp.com/userform?New+User=New+User";
    ...
    public static String newUserPageURL_ci = "https://tst.services.nhsbsa.nhs.uk/compman/userform?New+User=New+User";
	...
	public void BlankCreateUserUserMgtDetails() throws IOException {
		...
		createNewUserDetails.Username.sendKeys("");
     	...
     	driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
  		...
  		WebElement field1 = driver.findElement(By.xpath("//*[@id='content']/form/div[3]/div/span[1]/div/p"));
  		String message1  = field1.getText();
     	...
     	else 
     	{
  		...
  		WebElement field2 = driver.findElement(By.xpath("//*[@id='content']/form/div[3]/div/span[2]/div/p"));
  		String message2  = field2.getText();
     	...
     	else 
     	{
  		...
  		WebElement field3 = driver.findElement(By.xpath("//*[@id='content']/form/div[3]/div/span[3]/div/p"));
  		String message3  = field3.getText();
  		System.out.println("Password err rmsg........... " + message3);
  		if (message3.equals(err_msg13)) {
	 		
  			assertEquals("Error: Password err msg not correct! ", message3, err_msg13);
	 	}
  		else 
     	{
     		throw new IOException("NOT VALID Password err rmsg!!");
  		...
  		WebElement field4 = driver.findElement(By.xpath("//*[@id='content']/form/div[4]/div/div/p"));
