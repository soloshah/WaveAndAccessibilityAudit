    	...
    	String run_env = EnvConfig.getTestEnvironment();
	  	...
	  	switch (run_env){ 
	  	 case "localhost":
	        ...
	        break;
	     case "sys":
	    	 driver.navigate().to(GenericData.HOMEPAGE_LINK_SYS);
	        break;
	    case "cloud":
	    	Env.getHostName();
    	...
    	try {
    		...
    		switch (btnName){ 
    	     ...
    	     case "Create New User":
    	    	 driver.findElement(By.id("CreateNewUser")).click();
    	        break;
    	     case "Save User":
...
//	        //System.out.println("No of days b :"+ b); 
    ...
    public void clickLink(String linkName) throws InterruptedException {
    	...
    	try {
     	 ...
     	 case "editCustomer":
     		driver.findElement(By.xpath("html/body/main/div/div/div[2]/div[3]/span/a")).click();
    	        break;
    	        
    	  case "cemsReference":
    	    	WebElement element1 = driver.findElement(By.xpath(".//*[@id='content']/div/div/div[3]/table[2]/tbody/tr[2]/td[1]/a/span"));
        		 JavascriptExecutor executor1 = (JavascriptExecutor) driver;
        		 executor1.executeScript("arguments[0].click()", element1);
    	    	break;
    ...
    public void resolvedCaseseditComplaintNumber(String type, int priority, String ref, String assignedBy, String assignedByTeam, String summary, String upheld, int status, int MIcat, int MIOpt) {
	  	...
	  	driver.manage().timeouts().implicitlyWait(0, TimeUnit.MILLISECONDS);
	 	boolean exists = driver.findElements(By.xpath(".//*[@id='form']/div[2]/table/tbody/tr[3]/td[1]/a/span")).size() != 0;
		System.out.println("CEMS Ref in Resolved Cases tab Exists....! " + exists);
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    public void resolvedCaseseditComplaintLink(String type, int priority, String ref, String assignedBy, String assignedByTeam, String summary, String upheld, int status, int MIcat, int MIOpt) {
	...
	public void blankLoginDetails(String text) {
		...
		driver.findElement(By.className("login")).click();
     	...
     	if (username_message.equals("Please fill in this field.")) {
	 		...
	 		assertEquals("Error: UserName err msg not correct! ", username_message, "Please fill out this field.");
     	...
     	if (pwd_message.equals("Please fill in this field.")) {
	 		...
	 		assertEquals("Error: UserName err msg not correct! ", pwd_message, "Please fill out this field.");
