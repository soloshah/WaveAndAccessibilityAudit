...
public class EnvConfig extends Properties
{
	...
	private static String applicationcdnurl;
	private static String jquerycdnurl;
	...
	public EnvConfig()
	{
		try
		{
			...
			applicationcdnurl = System.getProperty(APPLICATIONCDNURL_PROPERTY, DEFAULT_APPLICATIONCDNURL);
			jquerycdnurl = System.getProperty(JQUERYCDNURL_PROPERTY, DEFAULT_APPLICATIONCDNURL);
	...
	public static final String APPLICATIONCDNURL_PROPERTY = "applicationcdnurl";
	public static final String JQUERYCDNURL_PROPERTY = "jquerycdnurl";
	...
	public static final String DEFAULT_APPLICATIONCDNURL = initProperties.getProperty(APPLICATIONCDNURL_PROPERTY);
	public static final String DEFAULT_JQUERYCDNURL = initProperties.getProperty(JQUERYCDNURL_PROPERTY);
