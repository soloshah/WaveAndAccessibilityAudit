...
@cipipeline
  Scenario Outline: Validation BLANK error messages for New Complaint
	...
	And I send and verify empty details Complaint Summary for New Complaint
	And I send and verify empty details Status for New Complaint
...
@cipipeline
	Scenario Outline: Validation Max characters complaint summary error message for Edit Complaint
 	Given I open the login page
 	When I enter '<username>' and '<password>'
    And I click the button "login" 
    And I am redirected to "home" page
